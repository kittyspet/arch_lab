...
mongoimport --uri 'mongodb://lab04_mongo:27017/arch' --collection confs --file import_json/ConfsJson.json --jsonArray
mongoimport --uri 'mongodb://lab04_mongo:27017/arch' --collection reports --file import_json/ReportsJson.json --jsonArray
